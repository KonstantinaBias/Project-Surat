                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="index.php?page=edit-srt-klr&& id=<?php echo $srt['id'];?>" class="btn btn-sm btn-info"><i class='fa fa-edit'></i></a>
                      <!-- data-toggle="modal"
                      data-target="#modal-view-<?php echo $srt['id'];?>" 
                      data-asal_surat="<?php echo $srt['tujuan_surat'];?>"
                      data-nmr_surat="<?php echo $srt['nmr_surat'];?>"
                      data-kode_surat="<?php echo $srt['kode_surat'];?>"
                      data-tgl_surat="<?php echo $srt['tgl_surat'];?>"
                      data-perihal="<?php echo $srt['perihal'];?>" -->
                      <a
